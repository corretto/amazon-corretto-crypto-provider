...
While ACCP was originally developed and built against OpenSSL's `libcrypto` as its native cryptography library, it is currently built against AWS-LC's `libcrypto` (which is itself a fork of BoringSSL).
