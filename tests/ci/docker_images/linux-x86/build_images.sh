...
docker build -t amazonlinux-2:clang-11x -f amazonlinux-2_clang-11x/Dockerfile ../../../../
docker build -t amazonlinux-2:clang-11x_cryptofuzz -f amazonlinux-2_clang-11x_cryptofuzz/Dockerfile ../../../../
