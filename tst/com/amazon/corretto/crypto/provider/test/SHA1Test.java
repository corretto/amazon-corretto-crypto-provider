...
public class SHA1Test {
  ...
  public void testNullDigest() throws Exception {
    ...
    assertArrayEquals(
        Hex.decodeHex("da39a3ee5e6b4b0d3255bfef95601890afd80709".toCharArray()), digest.digest());
    digest = getDigest();
  ...
  public void testVector() throws Exception {
    ...
    assertArrayEquals(
        Hex.decodeHex("dc724af18fbdd4e59189f5fe768a5f8311527050".toCharArray()), digest.digest());
  }
