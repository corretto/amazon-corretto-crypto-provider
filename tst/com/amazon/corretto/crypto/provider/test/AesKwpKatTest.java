...
public final class AesKwpKatTest {
    ...
    private static Stream<RspTestEntry> getEntriesFromFile(final String fileName) throws IOException {
        ...
        final Iterator<RspTestEntry> iterator = RspTestEntry.iterateOverResource(is, true); // Auto-closes stream
        final Spliterator<RspTestEntry> split = Spliterators.spliteratorUnknownSize(iterator, Spliterator.ORDERED);
    ...
    private void singleTest(final RspTestEntry entry) throws GeneralSecurityException, InvalidKeyException,
