...
public final class AesKwKatTest {
  ...
  private static Cipher getCipher() throws GeneralSecurityException {
    return Cipher.getInstance("AES/KW/NoPadding", TestUtil.NATIVE_PROVIDER);
  }
}
