...
{
    const EVP_CIPHER* cipher = EVP_xaes_256_gcm();
...
JNIEXPORT int JNICALL Java_com_amazon_corretto_crypto_provider_XAes256GcmSpi_oneShotEncrypt(JNIEnv* pEnv,
    jclass,
    jlong ctxPtr,
    jboolean sameKey,
    jlongArray ctxOut,
...
JNIEXPORT jlong JNICALL Java_com_amazon_corretto_crypto_provider_XAes256GcmSpi_encryptInit(
...
JNIEXPORT jint JNICALL Java_com_amazon_corretto_crypto_provider_XAes256GcmSpi_encryptUpdate(JNIEnv* pEnv,
    jclass,
    jlong ctxPtr,
    jbyteArray inputArray,
    jint inoffset,
...
JNIEXPORT void JNICALL Java_com_amazon_corretto_crypto_provider_XAes256GcmSpi_encryptUpdateAAD(
...
JNIEXPORT jint JNICALL Java_com_amazon_corretto_crypto_provider_XAes256GcmSpi_encryptDoFinal(JNIEnv* pEnv,
    jclass,
    jlong ctxPtr,
...
JNIEXPORT jint JNICALL Java_com_amazon_corretto_crypto_provider_XAes256GcmSpi_oneShotDecrypt(JNIEnv* pEnv,
    jclass,
    jlong ctxPtr,
    jboolean sameKey,
    jlongArray ctxOut,
