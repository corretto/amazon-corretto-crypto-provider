...
Java_com_amazon_corretto_crypto_provider_AmazonCorrettoCryptoProvider_isFipsStatusOk(JNIEnv*, jobject)
{
    return g_is_fips_status_ok.load() ? JNI_TRUE : JNI_FALSE;
}

// The following methods are for testing purposes
extern "C" JNIEXPORT void JNICALL Java_com_amazon_corretto_crypto_provider_test_NativeTestHooks_flipFipsStatus(
    JNIEnv*, jclass)
{
