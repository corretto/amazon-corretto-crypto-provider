...
public final class EcParameters extends AlgorithmParametersSpi {
  ...
  protected void engineInit(AlgorithmParameterSpec paramSpec) throws InvalidParameterSpecException {
    ...
    if (paramSpec instanceof ECParameterSpec) {
      ...
      // Earlier Java TLS implementations cache curve params by OID instead of human-readable
      // "shortname".
      // Specifying the shortname where OID is expected results in TLS handshake failures due to the
      // server
      // not being able to "find" the intended curve, tricking the server into believing it doesn't
      // support any
      ...
      // OpenJDK's JCE sometimes passes ECKeySizeParameterSpec when initializing EC
      // AlgorithmParameters. We can
      // reference this class directly using instanceof up until Java 8, but in Java 9 it was moved
      // to the
      // java.base module and only exported to other JDK-internal modules. To work around this, we
      // use reflection
      // to get the key size and get the corresponding curve name from our own database. Future
      // versions of java
      ...
      try {
        ...
        // pass, perhaps due to reflective access control restrictions. rely null check below to
        // throw.
      }
    }
