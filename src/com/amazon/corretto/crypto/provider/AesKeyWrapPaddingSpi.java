...
final class AesKeyWrapPaddingSpi extends CipherSpi {
    ...
    @Override
    protected void engineInit(int opmode, Key key, AlgorithmParameters ignored1, SecureRandom ignored2)
            throws InvalidKeyException {
        implInit(opmode, key);
    }

    @Override
    protected void engineInit(int opmode, Key key, AlgorithmParameterSpec ignored1, SecureRandom ignored2)
            throws InvalidKeyException {
        implInit(opmode, key);
    }
